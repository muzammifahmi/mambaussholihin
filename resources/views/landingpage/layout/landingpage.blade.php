...
<body>
    ...
    <section class="hero" id="beranda">
        ...
        <div class="hero-left">
            ...
            <div class="hero-actions">
                <a href="{{ route('formulir') }}" target="_blank" class="btn-primary">
                    Daftar Sekarang
        ...
        <div class="pengasuh-inner">
            ...
            <div class="pengasuh-img-col reveal delay-2">
                <div class="pengasuh-img-frame" id="pengasuhSlideshow">
                    ...
                    <img src="{{ asset('photos/buya-ori.jpg') }}" alt="Prof. Dr. KH. Nasrulloh, Lc., M.Th.I"
                        class="slide-img active">
                    <img src="{{ asset('photos/DSC09054.jpg') }}" alt="Foto Pengasuh 2" class="slide-img">
                    <img src="{{ asset('photos/IMG_6136.JPG') }}" alt="Foto Pengasuh 3" class="slide-img">
    ...
    <!-- GALLERY -->
    @include('landingpage.layout.gallery')

    <!-- FASILITAS -->
    @include('landingpage.layout.fasilitas')
